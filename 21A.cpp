...
void idharDekh()
{
    ...
    while(k<n){
        ...
        if(!((s[k]>='A' && s[k]<='Z') || (s[k]>='a' && s[k]<='z') || (s[k]>='0' && s[k]<='9') || s[k]=='.' || s[k]=='_')){
            //cout<<"k inside"<<s[k]<<endl;
            no;
            done;
        }
        if(s[k]=='.' && s[k-1]=='.'){
    ...
    while(op<n){
        if(!((s[op]>='A' && s[op]<='Z') || (s[op]>='a' && s[op]<='z') || (s[op]>='0' && s[op]<='9') || s[op]=='_')){
            //cout<<"op inside"<<endl;
            no;
            done;
        }
