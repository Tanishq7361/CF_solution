...
#define King(T)                   \
    ...
    cin.tie(nullptr)
#define My #ifndef ONLINE_JUDGE
#define Name freopen("Input.txt", "r", stdin);
#define is freopen("Output.txt", "w", stdout);
#define Tanishq freopen("Error.txt", "w", stderr);
#define Shah #endif
#define endl '\n'
#define ll long long
#define u unsigned
