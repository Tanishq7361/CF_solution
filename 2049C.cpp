...
template <typename T, typename V>
istream &operator>>(istream &cin, pair<T, V> &a) { return cin >> a.first >> a.second; }
template <typename T>
...
template <typename T, typename V>
ostream &operator<<(ostream &cout, const pair<T, V> &a) { return cout << a.first << ' ' << a.second; }
template <typename T>
...
void idharDekh()
{
    ...
    for (int i = x; i < n; i++)
    {
        if (i == y - 1)
        {
            ...
            if (y == n)
            {
                if (a[i - 1] != 0 && a[0] != 0 && a[x - 1] != 0)
                {
                    a[i] = 0;
                }
                else if (a[i - 1] != 1 && a[0] != 1 && a[x - 1] != 1)
                {
                    a[i] = 1;
                }
                else if (a[i - 1] != 2 && a[0] != 2 && a[x - 1] != 2)
                {
                    a[i] = 2;
                }
            }
            ...
            {
                if (a[i - 1] != 0 && a[i + 1] != 0 && a[x - 1] != 0)
                {
                    a[i] = 0;
                }
                else if (a[i - 1] != 1 && a[i + 1] != 1 && a[x - 1] != 1)
                {
                    a[i] = 1;
                }
                else if (a[i - 1] != 2 && a[i + 1] != 2 && a[x - 1] != 2)
                {
                    a[i] = 2;
                }
            }
        ...
        else if (i == n - 1)
        {
            ...
            else if (a[i - 1] != 1 && a[0] != 1)
            {
                a[i] = 1;
            }
            else if (a[i - 1] != 2 && a[0] != 2)
            {
                a[i] = 2;
            }
        }
    ...
    for (int i = 0; i < x - 1; i++)
    {
        if (i == 0)
        {
            ...
            else if (a[n - 1] != 1 && a[i + 1] != 1)
            {
                a[i] = 1;
            }
            else if (a[n - 1] != 2 && a[i + 1] != 2)
            {
                a[i] = 2;
            }
        }
