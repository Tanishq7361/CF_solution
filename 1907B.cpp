...
void idharDekh()
{
    ...
    ll j = 0, k = 0;
    ll sum1 = sml.size(), sum2 = cap.size();
    for (int i = 0; i < n; i++)
    {
        if (sml[j].ss == i && sum1)
        {
