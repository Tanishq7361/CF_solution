...
void idharDekh()
{
    ...
    fr(i,0,n){
        fr(j,0,m){
            b[i][j]+=a[i][j];
            if(i<n-1){
                b[i+1][j]+=max(0ll,a[i][j]-1);
            }
            if(i<n-2){
                b[i+2][j]+=max(0ll,a[i][j]-2);
            }
            if(i<n-3){
                b[i+3][j]+=max(0ll,a[i][j]-3);
            }
            if(i<n-4){
                b[i+4][j]+=max(0ll,a[i][j]-4);
            }
            if(j<m-1){
                b[i][j+1]+=max(0ll,a[i][j]-1);
            }
            if(j<m-2){
                b[i][j+2]+=max(0ll,a[i][j]-2);
            }
            if(j<m-3){
                b[i][j+3]+=max(0ll,a[i][j]-3);
            }
            if(j<m-4){
                b[i][j+4]+=max(0ll,a[i][j]-4);
            }
            if(i>0){
                b[i-1][j]+=max(0ll,a[i][j]-1);
            }
            ...
            if(i>0 && j>0){
                b[i-1][j-1]+=max(0ll,a[i][j]-2);
            }
            if(i>1 && j>1){
                b[i-2][j-2]+=max(0ll,a[i][j]-4);
            }
            if(i>1 && j>0){
                b[i-2][j-1]+=max(0ll,a[i][j]-3);
            }
            if(i>0 && j>1){
                b[i-1][j-2]+=max(0ll,a[i][j]-3);
            }
            if(i<n-1 && j<m-1){
                b[i+1][j+1]+=max(0ll,a[i][j]-2);
            }
